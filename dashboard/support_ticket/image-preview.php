<?php
// Returns a small HTML snippet for insertion into the page to preview an attachment
...
// The snippet is intentionally minimal — CSS loaded by the ticket pages
?>
<div class="ip-overlay" id="stImagePreviewOverlay">
  <div class="ip-modal">
    ...
    <div class="ip-body">
      <?php if ($isImage): ?>
        <img class="ip-image" src="controllers/attachments/serve.php?id=<?php echo $attachmentId; ?>" alt="<?php echo $fileName; ?>">
      <?php else: ?>
    ...
    <div class="ip-footer">
      <a class="tm-btn tm-btn--red ip-download" href="controllers/attachments/download.php?id=<?php echo $attachmentId; ?>">Download</a>
    </div>
  </div>
</div>
