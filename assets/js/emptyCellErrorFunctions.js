/**
 * Empty Cell Error Handling Functions
 * Contains the print and export functionality for empty cell error reports
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    filenamePHP = document.getElementById('original_filename') ? 
        document.getElementById('original_filename').value : 'empty_cell_errors';
...
function printReport() {
    try {
        ...
        var htmlContent = '<!DOCTYPE html>' +
            '<html>' +
            '<head>' +
            '    <title>Empty Cell Error Report</title>' +
            '    <style>' +
            ...
            '    </div>' +
            '    <div class="message">' +
            '        The following rows have empty values in the branch ID cell (Column N):' +
            '    </div>' +
        ...
        htmlContent +=
            ...
            '    </div>' +
            '    <div class="footer">' +
            '        <p>Please fill in the empty branch ID cells in column N before importing.</p>' +
...
/**
 * Export empty cell errors to PDF
 */
function exportToPDF() {
    try {
        ...
        form.method = "post";
        form.action = "emptyCellErrorExportToPdf.php";
