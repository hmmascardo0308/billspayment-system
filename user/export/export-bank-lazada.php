...
if(isset($_POST["export"])){
 if(empty($_POST["fromDate"])){
  ...
  $recordQuery = "SELECT * FROM billsPayment_others WHERE account_number LIKE '%0%0%6%1%0%0%0%1%2%8%0%5%3%' AND account_number != '0061000128053' AND partner_id = 'MLBPP220836' AND date_time BETWEEN '".$_POST["fromDate"]."' AND '".$_POST["toDate"]."' ORDER BY date_time ASC";
  ...
  if(count($filterRecord)) {
	  $fileName = "Generate Security Bank Lazada Records_".date('Ymd') . ".csv";
