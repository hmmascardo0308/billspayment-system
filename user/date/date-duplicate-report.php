...
if (isset($_POST['export-duplicate'])) {
    ...
    $filename = 'Bills Payment Duplicate Trabsactions_' . date('Y-m-d') . '.csv';
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <center><h5>Bills Payment Transaction (Duplicate/Split Transaction)</h5></center>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-btn">
                                            ...
                                            <input type="submit" name="export-duplicate" id="export" value="Export to CSV" class="btn btn-info" />
                                        </div>
                                    </div>
                                </div>
                            </form>
