<?php
@include '../export/export-bank-lazada.php';
$conn = mysqli_connect('localhost', 'root', 'Password1','mldb');
?>
<title>Security Bank Lazada Records</title> 
...
<div class="container">
    ...
    <div class="header-title">
        <h2>Generate Security Bank LAZADA Records</h2>
    </div>
 ...
 <tbody>
  <?php
   if(isset($_POST['fromDate']) && isset($_POST['toDate'])) {
    ...
    $query = "SELECT * FROM billsPayment_others WHERE account_number LIKE '%0%0%6%1%0%0%0%1%2%8%0%5%3%' AND account_number != '0061000128053' AND partner_id = 'MLBPP220836' AND date_time BETWEEN '".$_POST["fromDate"]."' AND '".$_POST["toDate"]."'";
